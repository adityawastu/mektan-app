...
<body>
    <div class="min-h-screen antialiased bg-gray-100 dark:bg-gray-900">
        ...
        <aside
                ...
                <ul class="space-y-2">
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <div class="py-3 px-4">
                                <span class="block text-sm font-semibold text-gray-900 dark:text-white">Ucok
                                    bucuk</span>
                                <span
                                    class="block text-sm text-gray-900 truncate dark:text-white">name@flowbite.com</span>
                            </div>
                            <!-- Dropdown menu -->
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-2 text-left whitespace-nowrap text-base font-normal">Asset
                                Management</span>
                        ...
                        <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                            ...
                            <li>
                                <a href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-sm text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Pemeliharaan
                                    Asset</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-sm  text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Calendar</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <div
                class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20 rounded-2xl">
                <a href="#"
